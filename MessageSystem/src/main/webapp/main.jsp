						...
						<nav>
							...
							<%}else{
								if(member.getM_email().equals("admin")){
									out.print("<a href = 'MemberSelectAllCon'>회원관리</a>");
								...
								<div class="inner">
									...
									<ul class="actions">
										...
										if(member == null){
											...
											//.isEmpty() : 배열에 데이터가 없는 경우 true를 반환.
											if(msglist.isEmpty()){ //배열이 비어있다면!(메세지가 한통도 없을 때!)
												...
												for(int i = 0; i < msglist.size(); i++){
													...
													out.print("<a href='MsgDeleteCon?num="+msglist.get(i).getM_num() +"'>삭제</a>"); //쿼리스트링을 활용하여 보내자!
													out.print("</li>");
