...
<%
/* ArrayList<MemberDTO> members = (ArrayList<MemberDTO>)request.getAttribute("members"); ->> el문법 사용시 필요없다!*/
/* //MemberDTO member = (MemberDTO)request.getAttribute("request");
...
<%-- 							<%
							if(members.isEmpty()){
								out.print("<tr><td colsapn = '3'>현재 가입된 회원이 없습니다.</td></tr>");
							}else{
